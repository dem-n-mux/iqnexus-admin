            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-4xl w-full mx-auto">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">
                        Bulk Kindergarten Student Data Upload
                    </h1>
                    <p className="text-gray-600">
                        Upload a list of kindergarten students using the official CSV template.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div
                            className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 cursor-pointer ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-gray-400'
                                }`}
                            onDrop={handleDrop}
                        ...
                        >
                            ...
                            <label htmlFor="fileInput" className="cursor-pointer block">
                                ...
                                <p className="mt-1 text-xs text-gray-500">Only .csv files allowed</p>
                            </label>
                        </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                        <h2 className="text-lg font-semibold text-gray-800">File Guidelines</h2>
                        <ul className="space-y-3 text-sm text-gray-600">
                            ...
                            <li className="flex items-start gap-2">
                                <div className="min-w-4 mt-1">•</div>
                                <p>
                                    Required columns: <strong>studentName</strong>, <strong>rollNo</strong>,{' '}
                            ...
                            <li className="flex items-start gap-2">
                                <div className="min-w-4 mt-1">•</div>
                                <p>
                                    Optional columns: <strong>motherName</strong>, <strong>fatherName</strong>,{' '}
                            ...
                            <li className="flex items-start gap-2">
                                <div className="min-w-4 mt-1">•</div>
                                <p>Class is fixed as "KG" and can be omitted.</p>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="min-w-4 mt-1">•</div>
                            ...
                            <li className="flex items-start gap-2">
                                <div className="min-w-4 mt-1">•</div>
                                <p>Each student must have a unique roll number.</p>
                            </li>
                        </ul>
                        ...
                        <div className="bg-blue-50 rounded-lg p-4 mt-6">
                            ...
                            <p className="text-sm text-blue-600">
                                If you need assistance with the upload process or have questions about the required format, please contact our support team.
                            </p>
                        </div>
                    </div>
                </div>
